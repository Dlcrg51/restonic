...
<div id="k2Container" class="container-fluid itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <!-- Item Image -->
	  <div class="itemImageBlock media-pg">
		  	...
		  	<?php if($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)): ?>
            	<?php $fields = array(); ?>
	            	...
	            	<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
	                	<?php
	                    	$fields[$extraField->name] = $extraField->value;
	                  	?>
	              	<?php endforeach; ?>
				<?php if (array_key_exists('Link to Source', $fields)): ?>
				  	<a rel="{handler: 'image'}" target="_blank" href="<?php echo  $fields['Link to Source']; ?>">
		  	...
		  	<?php if($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)): ?>
            	<?php $fields = array(); ?>
	            	...
	            	<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
	              	...
	              	<?php endforeach; ?>
				<?php if (array_key_exists('Link to Source', $fields)): ?>
				  	<a target="_blank" href="<?php echo  $fields['Link to Source']; ?>">
				  		<?php echo  $fields['Link Text']; ?>
				  	</a>
				<?php endif; ?>
			<?php endif; ?>
		<div class="clr"></div>
